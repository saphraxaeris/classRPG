...
db.open(function(err, db) {
    if(!err) {
       ...
       users.insert({name:"Jose Garcia",username:"jose",password:"J123!",email:"jose.garcia12@upr.edu",
        ...
        items.insert({_id:new BSON.ObjectId('abcdefghijkl'),sprite: 'yellow-potion.png', classId:'1', className:'CIIC5995', name:'Item 1', effect:'Testing'},function(err,data){
           console.log("Done");
        });
        items.insert({_id:new BSON.ObjectId('bcdefghijklm'),sprite: 'scroll.png', classId:'2', className:'ICOM5995', name:'Item 2' ,effect:'Testing 2'},function(err,data){
           console.log("Done");
        });
